...
var encodingTests = []struct {
	...
	{"1#21:53:37.963", &K{KT, NONE, []Time{Time(qEpoch.Add(21*time.Hour + 53*time.Minute + 37*time.Second + 963*time.Millisecond))}}, TimeVecBytes},
	{"21:22:01 + 1 2", &K{KV, NONE, []Second{Second(qEpoch.Add(76922 * time.Second)), Second(qEpoch.Add(76923 * time.Second))}}, SecondVecBytes},
	{"21:22*til 2", &K{KU, NONE, []Minute{Minute(qEpoch), Minute(qEpoch.Add(1282 * time.Minute))}}, MinuteVecBytes},
